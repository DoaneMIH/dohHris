...
//                 onSelected: (value) {
//                   // handle selection (navigate or open drawer, etc.)
//                   if (value == 'settings') {
...
//                             _buildFamilyBackgroundCard(),
//                             const SizedBox(height: 16),

//                             // Educational Background Section
//                             _buildEducationalBackgroundCard(),
//                             const SizedBox(height: 16),

//                             // Civil Service Eligibility Section
//                             _buildCivilServiceCard(),
//                             const SizedBox(height: 16),
...
//                             _buildVoluntaryWorkCard(),
//                             const SizedBox(height: 16),

//                             // Learning and Development Section
//                             _buildLearningDevelopmentCard(),
//                             const SizedBox(height: 16),
...
//                               Expanded(
//                                 child: isEditing
//                                     ? _buildEditableField('', training['title'], (
//                                         value,
//                                       ) {
//                                         _learningDevelopmentData[index]['title'] =
//                                             value;
//                                       })
//                                     : _buildInfoField('', training['title']),
//                               ),
//                               const SizedBox(width: 8),
//                               Row(
//                                 children: [
...
//                           Expanded(
//                             child: isEditing
//                                 ? _buildEditableField('', skill['skill'], (
//                                     value,
//                                   ) {
//                                     _specialSkillsData[index]['skill'] = value;
//                                   })
//                                 : _buildInfoField('', skill['skill']),
//                           ),
//                           const SizedBox(width: 8),
//                           IconButton(
//                             icon: Icon(
...
//                                         },
//                                       )
//                                     : _buildInfoField('', reference['name']),
//                               ),
//                               const SizedBox(width: 8),
//                               Expanded(
//                                 flex: 2,
...
//                                         },
//                                       )
//                                     : _buildInfoField('', reference['address']),
//                               ),
//                               const SizedBox(width: 8),
//                               Row(
//                                 children: [
...
//                     ),
//                   ] else ...[
//                     _buildInfoField('Issued ID', _governmentIDData['issuedID']),
//                     const SizedBox(height: 12),
//                     _buildInfoField(
//                       'Unified Multi-Purpose ID',
//                       _governmentIDData['unifiedMultiPurposeID'],
